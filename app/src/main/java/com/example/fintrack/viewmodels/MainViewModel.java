package com.example.fintrack.viewmodels;
   ...
   public MutableLiveData<Double> totalAmount = new MutableLiveData<>();
    ...
    public void getTransactions(Calendar calendar){
        ...
        if (Constants.SELECTED_TAB == Constants.DAILY) {
            ...
            // RealmResults<Transaction> newTransactions = realm.where(Transaction.class).equalTo("date",calendar.getTime()).findAll();
            ...
            income = realm.where(Transaction.class).
                    greaterThanOrEqualTo("date", startTime).
                    lessThanOrEqualTo("date", endTime).equalTo("type", Constants.INCOME).
                    sum("amount").doubleValue();

            expense = realm.where(Transaction.class).
                    greaterThanOrEqualTo("date", startTime).
                    lessThanOrEqualTo("date", endTime).equalTo("type", Constants.EXPENSE).
                    sum("amount").doubleValue();
